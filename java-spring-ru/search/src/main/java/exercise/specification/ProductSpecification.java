...
public class ProductSpecification {
    ...
    public Specification<Product> build(ProductParamsDTO params) {
        return withCategoryId(params.getCategoryId())
                ...
                .and(withStringLikeIgnoreCase(params.getTitleCont()));
    }
    ...
    private Specification<Product> withPriceLs(Integer priceLt) {
    ...
    private Specification<Product> withStringLikeIgnoreCase(String titleCont) {
