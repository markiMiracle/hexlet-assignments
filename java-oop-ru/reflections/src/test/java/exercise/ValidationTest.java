...
class ValidationTest {
    ...
    @Test
    void testAdvancedValidate() throws IllegalAccessException, NoSuchMethodException {
        Address address1 = new Address("Russia", "UfaUfa", "Lenina", "54", null);
        Map<String, List<String>> result1 = Validator.advancedValidate(address1);
        Map<String, List<String>> expected1 = Map.of();
        assertThat(result1).isEqualTo(expected1);

        Address address3 = new Address("Rus", null, "L", "54", "54");
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 = Map.of("city", List.of("cannot be null"),
                "street", List.of("length less than 2"));
        assertThat(result3).isEqualTo(expected3);
    }
}
